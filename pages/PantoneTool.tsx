...
const PantoneTool: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 pb-12">
      ...
      {/* Unified Banner - Orange/Red */}
      <div className="relative w-full bg-gradient-to-r from-orange-500 via-red-500 to-rose-600 rounded-[2.5rem] p-10 overflow-hidden shadow-2xl mb-8">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
             <div className="flex flex-col items-center md:items-start text-center md:text-start flex-1">
                 ...
                 <p className="text-orange-100 text-lg font-medium max-w-xl leading-relaxed opacity-95">
                     {isRTL 
